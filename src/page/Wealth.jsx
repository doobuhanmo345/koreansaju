...
3. [Natural Closing]: 답변을 마칠 때, '[추천 질문]' 같은 딱딱한 제목이나 번호 매기기(1., 2.)를 절대 사용하지 마십시오. 대신, **대화를 자연스럽게 이어가기 위해 의뢰자가 궁금해할 법한 내용 2~3가지를 문장 속에 녹여서 슬쩍 제안**하세요. - (예: "이 외에도 선생님의 타고난 금전 그릇 크기나, 조심해야 할 사람에 대해서도 궁금하신가요? 궁금하신 사항이 있다면 '추가질문'을 눌러주세요.")
...
`;
      ...
      const fullPrompt = `
        ...
        - 현재 날짜 : ${todayStr}나를 선생님이 아닌 ${userData?.displayName}님 이라고 불러줘.영어로는 ${userData?.displayName}. undefined시는 그냥 선생님이라고 해..
